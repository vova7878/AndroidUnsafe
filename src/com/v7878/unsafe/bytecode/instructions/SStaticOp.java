...
public abstract class SStaticOp extends Instruction {
    ...
    public static class SGetWide extends SStaticOp {
        ...
        static void init() {
            InstructionReader.register(OPCODE, new Reader_20bc_21c((rc, A, B) -> {
                return new SGetWide(A, rc.fields[B]);
            }));
        }
    ...
    public static class SGetObject extends SStaticOp {
        ...
        static void init() {
            InstructionReader.register(OPCODE, new Reader_20bc_21c((rc, A, B) -> {
                return new SGetObject(A, rc.fields[B]);
            }));
        }
    ...
    public static class SGetBoolean extends SStaticOp {
        ...
        static void init() {
            InstructionReader.register(OPCODE, new Reader_20bc_21c((rc, A, B) -> {
                return new SGetBoolean(A, rc.fields[B]);
            }));
        }
    ...
    public static class SGetByte extends SStaticOp {
        ...
        static void init() {
            InstructionReader.register(OPCODE, new Reader_20bc_21c((rc, A, B) -> {
                return new SGetByte(A, rc.fields[B]);
            }));
        }
    ...
    public static class SGetChar extends SStaticOp {
        ...
        static void init() {
            InstructionReader.register(OPCODE, new Reader_20bc_21c((rc, A, B) -> {
                return new SGetChar(A, rc.fields[B]);
            }));
        }
    ...
    public static class SGetShort extends SStaticOp {
        ...
        static void init() {
            InstructionReader.register(OPCODE, new Reader_20bc_21c((rc, A, B) -> {
                return new SGetShort(A, rc.fields[B]);
            }));
        }
    ...
    public static class SPutWide extends SStaticOp {
        ...
        static void init() {
            InstructionReader.register(OPCODE, new Reader_20bc_21c((rc, A, B) -> {
                return new SPutWide(A, rc.fields[B]);
            }));
        }
    ...
    public static class SPutObject extends SStaticOp {
        ...
        static void init() {
            InstructionReader.register(OPCODE, new Reader_20bc_21c((rc, A, B) -> {
                return new SPutObject(A, rc.fields[B]);
            }));
        }
    ...
    public static class SPutBoolean extends SStaticOp {
        ...
        static void init() {
            InstructionReader.register(OPCODE, new Reader_20bc_21c((rc, A, B) -> {
                return new SPutBoolean(A, rc.fields[B]);
            }));
        }
    ...
    public static class SPutByte extends SStaticOp {
        ...
        static void init() {
            InstructionReader.register(OPCODE, new Reader_20bc_21c((rc, A, B) -> {
                return new SPutByte(A, rc.fields[B]);
            }));
        }
    ...
    public static class SPutChar extends SStaticOp {
        ...
        static void init() {
            InstructionReader.register(OPCODE, new Reader_20bc_21c((rc, A, B) -> {
                return new SPutChar(A, rc.fields[B]);
            }));
        }
    ...
    public static class SPutShort extends SStaticOp {
        ...
        static void init() {
            InstructionReader.register(OPCODE, new Reader_20bc_21c((rc, A, B) -> {
                return new SPutShort(A, rc.fields[B]);
            }));
        }
