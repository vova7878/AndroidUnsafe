...
public class ClassData {
    ...
    public static ClassData read(RandomInput in, ReadContext rc,
        ...
        EncodedField[] static_fields = EncodedField.readArray(in, rc,
        ...
        out.instance_fields = EncodedField.readArray(in, rc,
                instance_fields_size, annotations.annotated_fields);
        out.direct_methods = EncodedMethod.readArray(in, rc,
                direct_methods_size, annotations.annotated_methods,
                annotations.annotated_parameters);
        out.virtual_methods = EncodedMethod.readArray(in, rc,
